...
public class MainActivity extends Activity implements Replication.ChangeListener,
    ...
    //constants
    public static final String DATABASE_NAME = "pronos-app";
    public static final String designDocName = "pronos-local";
    ...
    public static final String SYNC_URL = "http://girafe31.iriscouch.com/pronos-app";  // 10.0.2.2 == Android Simulator equivalent of 127.0.0.1
    //splash screen
    ...
    protected EventAdapter itemListViewAdapter;
    ...
    private void displayRows(QueryEnumerator queryEnumerator) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                itemListViewAdapter = new EventAdapter(
...
*/
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
        Log.i(TAG, "click on " + String.valueOf(id));
        ...
        Event.Pronostic prono = Event.Pronostic.valueOf(newProperties.get("prono").toString().toUpperCase());

        //newProperties.put("prono", prono.opposite().name().toLowerCase());
        view.getTag();
        try {
